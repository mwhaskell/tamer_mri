function [ fit_hf] = mt_fit_fcn_v9_fixed_shot( dM_in, dM_in_indices, Mn, Cfull, km, ...
    tse_traj, U ,  full_msk_pxls, xprev, exp_str, kfilter,rI_off,ks_in,cvar)
...
cor_shots = mod(dM_in_indices(cvar)-1,size(Mn,1))+1; 

%% project back
ks = A(xprev(full_msk_pxls),U,Cfull,tse_traj,Ms,full_msk_pxls,rI_off,cor_shots,ks_in);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%              A                       %%%%%%%%%%%%%%%%%%%%%%%%%%%
function [kdata] = A(x,U,Cfull,tse_traj,Ms,nz_pxls_in,rI_off,cor_shots,ks)
...
for t = cor_shots
    ...
    Cfull2_sli(:,:,1,:) = squeeze(Cfull(:,:,tmp_sli,:));
end
